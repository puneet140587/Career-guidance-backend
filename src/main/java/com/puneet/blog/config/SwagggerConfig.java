...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : API's",
				"This project is developed by Puneet Shrivastava", "1.0", "Terms of Service",
				new Contact("Puneet Shrivastava", "https://learncodewithpuneet.com", "puneet.shrivastava@ymail.com"),
